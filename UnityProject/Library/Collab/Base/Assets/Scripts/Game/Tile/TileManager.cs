...
public class TileManager : MonoBehaviour {
	...
	bool AddToCoverSpots(Tile newCoverSpot) {
		...
		//Debug.Log((newCoverSpot.ToVector3() + Vector3.left * 0.5f + Vector3.up) + ", " + 
		//	(newCoverSpot.ToVector3() + Vector3.right * 0.5f + Vector3.up));
		//Instantiate(testerParticle, newCoverSpot.ToVector3() + Vector3.up, Quaternion.identity);
